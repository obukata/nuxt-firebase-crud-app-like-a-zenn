    ...
    <div v-show="isOpen" @click="isOpen = false">
      <div :style="navPosition" class="absolute z-20 shadow rounded-md bg-white w-56">
        <div class="p-4 hover:bg-slate-100">
          <div class="font-semibold text-sm whitespace-nowrap overflow-ellipsis overflow-hidden">obukata</div>
          <div class="text-slate-400 text-xs whitespace-nowrap overflow-ellipsis overflow-hidden">obukata@obukata.com</div>
        </div>
        <div class="border-t">
        ...
        <div class="border-t">
          <div class="block text-sm py-2.5 px-4 hover:bg-slate-100">🏝 ログアウト</div>
        </div>
      </div>
